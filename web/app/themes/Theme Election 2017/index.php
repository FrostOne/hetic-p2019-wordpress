...
<div class="carousel__slider js_slider js_simple">
    ...
    <div class="carousel__text">
        ...
        <a class ="button" href="http://localhost:8888/H3/hetic-p2019-wordpress/web/wp/wp-login.php?action=register" class="lwa-links-register lwa-links-modal">SOUTENEZ <strong>LE VOTE BLANC</strong> </a>
    </div>
</div>
